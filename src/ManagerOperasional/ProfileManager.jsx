...
import CardProfileKaryawan from '../Components/cardprofilemanager';
...
import CardProfileManager from '../Components/cardprofilemanager';
...
function KaryawanProfile() {
    ...
    const handleEditButtonClick = () => {
        setFormVisible(true);
        setFormTitle('Edit Profile Manager');
        setFormData({
