...
const Forbidden = () => {
    return (
        <div className='min-h-screen bg-[#233142] flex flex-col items-center justify-center'>
            <svg
                version='1.1'
                ...
                xmlSpace='preserve'
                className='w-1/5 fill-[#f95959] mb-8 animate-wiggle'
            >
                <metadata>
                    {' '}
            ...
            <h1 className='text-[#facf5a] text-center font-raleway font-extrabold text-[90px] mt-[-100px] mb-5'>
                403
            </h1>
            <h2 className='text-[#455d7a] text-center font-raleway text-[30px] uppercase'>
