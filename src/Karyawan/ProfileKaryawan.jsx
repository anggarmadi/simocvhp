...
import CardProfileKaryawan from '../Components/cardprofilekaryawan';
import Loading from '../Components/loadingKaryawan';
import Snackbar from '../Components/snackbar';
import api from '../auth/AxiosInstance';
import Button from '../Components/buttonform';
import secureLocalStorage from 'react-secure-storage';
import '../css/KaryawanProfile.css';
import '../css/CardProfileKaryawan.css';
...
function KaryawanProfile() {
    ...
    const handleEditButtonClick = () => {
        setFormVisible(true);
        setFormTitle('Edit Profile Karyawan');
        setFormData({
